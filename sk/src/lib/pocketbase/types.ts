...
export type GameStateResponse<Texpand = unknown> = Required<GameStateRecord> &
	BaseSystemFields<Texpand>;
export type ReesesProductsResponse<Texpand = unknown> = Required<ReesesProductsRecord> &
	BaseSystemFields<Texpand>;
export type ReesesVotesResponse<Texpand = unknown> = Required<ReesesVotesRecord> &
	BaseSystemFields<Texpand>;
export type RogueAgentsResponse<Texpand = unknown> = Required<RogueAgentsRecord> &
	BaseSystemFields<Texpand>;
